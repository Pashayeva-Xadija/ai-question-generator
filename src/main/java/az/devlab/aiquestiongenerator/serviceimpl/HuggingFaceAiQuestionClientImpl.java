...
public class HuggingFaceAiQuestionClientImpl implements AiQuestionClient {
    ...
    @Override
    public List<HuggingFaceResponsePayload> generateRawQuestions(QuestionGenerationRequest request,
                                                                 int normalizedCount) {
